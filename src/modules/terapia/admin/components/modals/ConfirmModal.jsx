...
export default function ConfirmModal({ open, onClose, selected, error, loading, onSubmit }) {
    if (!open) return null;
            ...
            <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl border border-slate-200 overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                    ...
                    <p className="text-sm text-slate-500">
                        Esto marcará la cita como <span className="font-semibold">CONFIRMADO</span> y notificará al usuario.
                    </p>

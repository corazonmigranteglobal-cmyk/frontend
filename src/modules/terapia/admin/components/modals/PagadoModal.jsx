...
export default function PagadoModal({ open, onClose, selected, error, loading, onSubmit }) {
    if (!open) return null;
            ...
            <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl border border-slate-200 overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                    ...
                    <p className="text-sm text-slate-500">
                        Esto marcará la cita como <span className="font-semibold">PAGADO</span>.
                    </p>
                ...
                <div className="p-6 border-t border-slate-100 flex justify-end gap-3 bg-slate-50">
                    ...
                    <button
                        ...
                        onClick={onSubmit}
                        disabled={loading}
                        className="px-6 py-2 rounded-xl bg-violet-700 text-white text-sm font-bold disabled:opacity-60"
                    >

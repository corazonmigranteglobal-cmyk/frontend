export const TERAPIA_ENDPOINTS = {
    ...
    ENFOQUES_LISTAR: "/api/terapia/enfoques/listar",
    ENFOQUES_APAGAR: "/api/terapia/enfoques/apagar",

    PRODUCTOS_CREAR: "/api/terapia/productos/crear",
    PRODUCTOS_MODIFICAR: "/api/terapia/productos/modificar",
    PRODUCTOS_LISTAR: "/api/terapia/productos/listar",
    ...
    HORARIOS_OBTENER: "/api/terapia/horarios/obtener",
    HORARIOS_APAGAR: "/api/terapia/horarios/apagar",
    HORARIOS_MODIFICAR: "/api/terapia/horarios/actualizar-versionado",
    HORARIOS_OBTENER_DISPONIBILIDAD: "/api/terapia/horarios/obtener-disponibilidad",
}